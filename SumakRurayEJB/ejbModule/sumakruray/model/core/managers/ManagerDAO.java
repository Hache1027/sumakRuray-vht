...
public class ManagerDAO {
	...
	@SuppressWarnings("rawtypes")
	public List findWheretwoClass(Class clase, Class clase2, String pClausulaWhere, String pOrderBy) {
		Query q;
		List listado;
		String sentenciaJPQL;
		if (pOrderBy == null || pOrderBy.length() == 0)
			sentenciaJPQL = "SELECT DISTINCT o FROM " + clase.getSimpleName() + " o," + clase2.getSimpleName()
					+ " WHERE NOT EXISTS (SELECT e FROM " + clase2.getSimpleName() + " e WHERE " + pClausulaWhere + ")";
	...
	@SuppressWarnings("rawtypes")
	public List findWhereString(Class clase, String pClausulaWhere, String pOrderBy) {
		Query q;
		List listado;
		String sentenciaJPQL;
		if (pOrderBy == null || pOrderBy.length() == 0)
	...
	public void eliminar(Class clase, Object pID) throws Exception {
		...
		System.out.println(pID + "--- metodo eliminar");
